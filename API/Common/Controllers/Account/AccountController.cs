...
using Application.Common.User.Queries.GetUserBillingInfo;
using Application.Common.User.Queries.GetUserContact;
...
using Application.Common.User.Queries.GetUsersForProfessional;
...
namespace Common.Controllers.Account
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        /// <param name="query"></param>
        /// <returns>All Users</returns>
        [HttpPost("GetUsersForProfessionals")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.COMPANY},{Roles.USERPRO}")]
        public async Task<ActionResult<GetUsersForProfessionalQueryResult>> GetUsers([FromBody] GetUsersForProfessionalQuery query)
        {
            return await this.HandleCommandResult(_mediator.Send(query));
        }
        ...
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        ...
        [HttpPost("GetUserContact")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        public async Task<ActionResult<GetUserContactQueryResult>> GetUserContact([FromBody] GetUserContactQuery query)
        {
            return await this.HandleCommandResult(_mediator.Send(query));
        }
        [HttpPost("UpdateUserContact")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        public async Task<ActionResult<UpdateUserContactCommandResult>> UpdateUserContact([FromBody] UpdateUserContactCommand command)
        {
            return await this.HandleCommandResult(_mediator.Send(command));
        }
        
        
        [HttpPost("GetUserBillingInfo")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        public async Task<ActionResult<GetUserBillingInfoQueryResult>> GetUserBillingInfo([FromBody] GetUserBillingInfoQuery query)
        {
            return await this.HandleCommandResult(_mediator.Send(query));
        }
        [HttpPost("UpdateUserBillingInfo")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        public async Task<ActionResult<UpdateUserBillingInfoCommandResult>> UpdateUserBillingInfo([FromBody] UpdateUserBillingInfoCommand command)
        {
            return await this.HandleCommandResult(_mediator.Send(command));
        }
        
        
        [HttpPost("GetUserSocial")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        public async Task<ActionResult<GetUserSocialQueryResult>> GetUserSocial([FromBody] GetUserSocialQuery query)
        {
            return await this.HandleCommandResult(_mediator.Send(query));
        }
        [HttpPost("UpdateUserSocial")]
        [Authorize(Roles = $"{Roles.ADMIN},{Roles.USER},{Roles.USERPRO},{Roles.COMPANY}")]
        public async Task<ActionResult<UpdateUserSocialsCommandResult>> UpdateUserSocial([FromBody] UpdateUserSocialsCommand command)
        {
            return await this.HandleCommandResult(_mediator.Send(command));
        }
