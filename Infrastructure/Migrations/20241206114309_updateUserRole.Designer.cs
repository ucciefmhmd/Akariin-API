...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241206114309_updateUserRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Chat.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Products.CartShippingAddress", b =>
                {
                    b.Property<Guid>("CartId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("CartId", "ShippingAddressId");

                    b.HasIndex("ShippingAddressId");

                    b.ToTable("CartShippingAddresses");
                });
            ...
            modelBuilder.Entity("Domain.Models.Products.OrderShippingAddress", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("OrderId", "ShippingAddressId");
            ...
            modelBuilder.Entity("Domain.Models.Products.ProductTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Professionals.ProjectTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Settings.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Settings.PrivacyLocalization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PrivacyLocalizations");
                });

            modelBuilder.Entity("Domain.Models.Settings.ShippingAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Settings.ShippingPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Chat.ChatMessage", b =>
                {
                    ...
                    b.HasOne("Domain.Identity.ApplicationUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Products.CartShippingAddress", b =>
                {
                    b.HasOne("Domain.Models.Products.Cart", "Cart")
                        .WithMany("CartShippingAddresses")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.Settings.ShippingAddress", "ShippingAddress")
                        .WithMany("CartShippingAddresses")
            ...
            modelBuilder.Entity("Domain.Models.Professionals.ProfessionalCategory", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Professionals.ProfessionalCategory", "ParentCategory")
                        .WithMany("ChildCategories")
                        .HasForeignKey("ParentCategoryId");
            ...
            modelBuilder.Entity("Domain.Models.Professionals.Project", b =>
                {
                    b.HasOne("Domain.Identity.ApplicationUser", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Settings.PrivacyLocalization", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Settings.Privacy", "Privacy")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("Domain.Models.Products.Cart", b =>
                {
                    ...
                    b.Navigation("CartShippingAddresses");
                });
