        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebsiteOrBlog = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    BillingFatherName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingFamilyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingFullNameInEnglish = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingMainPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingAlternativePhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Members_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RealEstates_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RealEstates_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RealEstateUnits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RealEstateUnits_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RealEstateUnits_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contracts_RealEstateUnits_RealEstateUnitId1",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contracts_RealEstates_RealEstateId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_RealEstateId1",
                table: "Contracts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_RealEstateUnitId1",
                table: "Contracts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealEstates_CreatedById",
                table: "RealEstates",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_RealEstates_ModifiedById",
                table: "RealEstates",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealEstateUnits_CreatedById",
                table: "RealEstateUnits",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_RealEstateUnits_ModifiedById",
                table: "RealEstateUnits",
                column: "ModifiedById");
